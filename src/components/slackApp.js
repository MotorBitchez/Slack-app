...
const TypingUser = props => {
  ...
  return(
    <div  id="user-container" >
      <img id="user-image" />
      <span id="typing-message">Sinan odak is typing...</span>
    </div>
  )
}
    ...
    return(
      <div className={appStyle}> 
        <div className={leftPanel}>
          ...
          <div className={channelsContainner}>
        ...
        <div className={messagePanel}>
            ...
            {this.props.messages.map((message)=>{
              ...
              if(message.messageDay){ 
                seperator = <Seperator day={message.messageDay}/>
              } 
              if(!message.subtype){
              ...
              else if(message.subtype == 'bot_add' || message.subtype == 'bot_remove'){ 
                return <div key={message.key}> 
                        {seperator}
                        <BotAddMessage message={message} 
...
const messagePanel = css`
  ...
  height: 100vh;
  transition: all 0.3s;
  background: linear-gradient(to right bottom, rgba(76, 175, 80, 0.07), rgba(255, 193, 7, 0.07), 
    rgba(33, 150, 243, 0.07), rgba(236, 64, 122, 0.07));
  `;
